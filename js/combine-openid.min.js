var providers;var openid={version:'1.2',demo:false,demo_text:null,cookie_expires:6*30,cookie_name:'openid_provider',cookie_path:'/',img_path:'images/',lang:null,signin_text:null,input_id:null,provider_url:null,provider_id:null,all_small:false,no_sprite:false,image_title:'{provider}',init:function(input_id){providers=$.extend({},providers_large,providers_small);var openid_btns=$('#openid_btns');this.input_id=input_id;$('#openid_choice').show();$('#openid_input_area').empty();var i=0;for(id in providers_large){if(this.all_small){openid_btns.append(this.getBoxHTML(id,providers_large[id],'small',i++));}else
openid_btns.append(this.getBoxHTML(id,providers_large[id],'large',i++));}
if(providers_small){openid_btns.append('<br/>');for(id in providers_small){openid_btns.append(this.getBoxHTML(id,providers_small[id],'small',i++));}}
...
html+='<input id="'+id+'" type="text" style="'+style+'" name="'+id+'" value="'+value+'" />'+'<input id="openid_submit" type="submit" value="'+this.signin_text+'"/>';input_area.empty();input_area.append(html);$('#'+id).focus();},setDemoMode:function(demoMode){this.demo=demoMode;}};
var providers_large={google:{name:"Google",url:"https://www.google.com/accounts/o8/id"},yahoo:{name:"Yahoo",url:"http://me.yahoo.com/"},aol:{name:"AOL",label:"Enter your AOL screenname.",url:"http://openid.aol.com/{username}"},myopenid:{name:"MyOpenID",label:"Enter your MyOpenID username.",url:"http://{username}.myopenid.com/"},openid:{name:"OpenID",label:"Enter your OpenID.",url:null}};var providers_small={livejournal:{name:"LiveJournal",label:"Enter your Livejournal username.",url:"http://{username}.livejournal.com/"},wordpress:{name:"Wordpress",label:"Enter your Wordpress.com username.",url:"http://{username}.wordpress.com/"},blogger:{name:"Blogger",label:"Your Blogger account",url:"http://{username}.blogspot.com/"},verisign:{name:"Verisign",label:"Your Verisign username",url:"http://{username}.pip.verisignlabs.com/"},claimid:{name:"ClaimID",label:"Your ClaimID username",url:"http://claimid.com/{username}"},clickpass:{name:"ClickPass",label:"Enter your ClickPass username",url:"http://clickpass.com/public/{username}"},google_profile:{name:"Google Profile",label:"Enter your Google Profile username",url:"http://www.google.com/profiles/{username}"}};openid.lang="en";openid.demo_text="In client demo mode. Normally would have submitted OpenID:";openid.signin_text="Sign-In";openid.image_title="log in with {provider}";
